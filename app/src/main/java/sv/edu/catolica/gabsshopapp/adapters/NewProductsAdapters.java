...
public class NewProductsAdapters extends RecyclerView.Adapter<NewProductsAdapters.ViewHolder> {

    private Context context;
    private List<NewProductsModel>list;

    public NewProductsAdapters(Context context, List<NewProductsModel> list) {
