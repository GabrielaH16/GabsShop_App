...
public class DepoActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.itInicio:
                Intent Home = new Intent(DepoActivity.this, Splash.class);
                startActivity(Home);
                break;

            case R.id.itAcerca:
                Intent About = new Intent(DepoActivity.this, Acerca_nosotros.class);
                startActivity(About);
                break;

            case R.id.itCategorias:
                Intent Categories = new Intent(DepoActivity.this, CategoriesActivity.class);
